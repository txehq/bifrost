...
export const ModelPlaceholders = {
	...
	modelark: "e.g. skylark-embedding-vision-251215",
	moonshot: "e.g. kimi-k2-0711-preview",
	mistral: "e.g. mistral-7b-instruct, mixtral-8x7b",
	openrouter: "e.g. openai/gpt-4, anthropic/claude-3-haiku",
	qwen: "e.g. qwen-plus, qwen3-max",
	...
	volcengine: "e.g. doubao-seed-1-6-251215, doubao-embedding-vision-251215",
...
export const PROVIDER_SUPPORTED_REQUESTS: Record<BaseProvider, string[]> = {
	...
	huggingface: ["list_models", "chat_completion", "chat_completion_stream", "responses", "responses_stream"],
	minimax: [
		"list_models",
		"text_completion",
		"text_completion_stream",
