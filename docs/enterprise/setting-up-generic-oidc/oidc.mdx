...
<Frame caption="The Trusted Networks control on the Provider Configuration screen, shown for self-hostable providers.">
  <img src="/media/user-provisioning/generic-oidc/bifrost-trusted-networks.png" alt="Bifrost Generic OIDC Provider Configuration screen with a Trusted Networks button above the Issuer URL field" />
</Frame>
