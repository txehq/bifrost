...
| `tool_call_names` | Requests whose response called any of these functions | `get_weather,search` |
...
<CardGroup cols={2}>
  ...
  <Card title="Datadog" icon="dog" href="/features/observability/datadog">
