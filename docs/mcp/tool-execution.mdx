...
This applies to `POST /v1/mcp/tool/execute`, [Agent Mode](./agent-mode) tool calls, and tool calls over the [MCP Gateway](./overview#bifrost-as-an-mcp-gateway) alike.
