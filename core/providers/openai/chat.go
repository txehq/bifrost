...
func ToOpenAIChatRequest(ctx *schemas.BifrostContext, bifrostReq *schemas.BifrostChatRequest) *OpenAIChatRequest {
	...
	case schemas.DeepSeek:
		openaiReq.filterOpenAISpecificParametersInternal(caps, false)
...
func (req *OpenAIChatRequest) filterOpenAISpecificParameters(caps schemas.ModelCaps) {
	req.filterOpenAISpecificParametersInternal(caps, true)
}

func (req *OpenAIChatRequest) filterOpenAISpecificParametersInternal(caps schemas.ModelCaps, normalizeReasoning bool) {
...
func (req *OpenAIChatRequest) stripReasoningDetails() {
	for i := range req.Messages {
		if assistant := req.Messages[i].OpenAIChatAssistantMessage; assistant != nil {
