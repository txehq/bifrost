...
func patchPricing(pricing configstoreTables.TableModelPricing, override Options) configstoreTables.TableModelPricing {
	...
	for _, field := range []struct {
		...
		{dst: &patched.OutputCostPerImageAbove8Megapixels, src: override.OutputCostPerImageAbove8Megapixels},
		{dst: &patched.OutputCostPerImageAbove16Megapixels, src: override.OutputCostPerImageAbove16Megapixels},
		{dst: &patched.OutputCostPerImageAbove32Megapixels, src: override.OutputCostPerImageAbove32Megapixels},
