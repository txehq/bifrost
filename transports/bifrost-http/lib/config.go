...
import (
	...
	"github.com/capsohq/bifrost/framework/mcp_headers"
	...
	"github.com/capsohq/bifrost/plugins/prompts"
	"github.com/capsohq/bifrost/plugins/routing"
	"github.com/capsohq/bifrost/plugins/routing/complexity"
	"github.com/capsohq/bifrost/plugins/routing/rules"
...
func ResolveFrameworkPricingConfig(
	...
	pricingSyncIntervalSource := "default"
	...
	if fileSyncSeconds != nil {
		...
		pricingSyncIntervalSource = "file"
	...
	logger.Debug(
		"resolved pricing config: url=%s source: %s sync_interval=%d seconds source: %s",
		*resolvedPricingURL,
		pricingURLSource,
		*resolvedSyncSeconds,
		pricingSyncIntervalSource,
	)
